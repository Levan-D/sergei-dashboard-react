...
export const IconHeart = ({ size = 24, className }: IconProps) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M14 3.61483C14.9187 2.54016 16.508 1.3335 18.928 1.3335C23.1613 1.3335 26 5.30683 26 9.00683C26 16.7415 16.3707 22.6668 14 22.6668C11.6293 22.6668 2 16.7415 2 9.00683C2 5.30683 4.83867 1.3335 9.072 1.3335C11.492 1.3335 13.0813 2.54016 14 3.61483Z"
      fill="currentColor"
      stroke="currentColor"
      strokeWidth="0"
      strokeLinecap="round"
...
export const IconComment = ({ size = 24, className }: IconProps) => (
  ...
  >
    <path
      d="M10.8183 4C10.9533 4 11.0882 4 11.2232 4C12.8433 4 14.5985 4 16.2186 4C16.6236 4 17.5687 4 20.2688 4C20.9439 4 21.4839 4.13394 21.6189 4.13394C26.6142 5.07175 30.1244 10.1628 29.1793 15.2537C28.3693 20.0767 24.5891 23.426 19.7288 23.426C18.3787 23.426 18.5137 23.426 17.1636 23.426C16.8936 23.426 16.6236 23.5599 16.3536 23.6939C15.0035 24.7656 13.6534 25.8375 12.4383 26.9092C12.0333 27.3111 11.4933 27.5792 10.9533 27.8471C10.0082 28.2491 9.06322 27.8471 8.7932 26.7753C8.65819 26.3734 8.65809 25.9714 8.52309 25.5695C8.52309 24.7657 8.52309 23.9619 8.52309 23.292C8.52309 22.8901 8.38805 22.6222 7.98302 22.4882C4.33782 20.6126 2.31283 16.9953 2.71786 12.7082C2.85287 8.28711 6.36306 4.53589 10.8183 4Z"
      fill="currentColor"
    />
  </svg>
);
...
export const IconRepost = ({ size = 24, className }: IconProps) => (
  ...
  >
    <path
      d="M5.97656 15.4954C6.75505 16.7372 7.86194 17.8104 9.88512 18.3675C11.9274 18.929 14.1851 18.6709 15.8975 17.4233C17.5204 16.2417 18.4089 14.5571 18.6581 12.8008"
      stroke="#"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M5 10.8439C5.2507 9.08172 6.145 7.39573 7.76942 6.21554C9.47886 4.97377 11.7308 4.72307 13.7686 5.28312C15.8006 5.84022 16.9089 6.91046 17.6816 8.14929"
      stroke="#"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M5.70703 18.4282V15.4961H8.63918"
      stroke="#"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path d="M17.9517 5.21875V8.1509H15.0195" stroke="#" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
