...
import { Button, FormGroup, SectionCard, SectionHeader } from '@/components/ui';
  ...
  return (
    <SectionCard>
      <SectionHeader
        ...
        right={
          <Button sm onClick={() => dispatch(showToast('✅ Second screen saved'))}>
            Save Changes
          </Button>
        }
      />
      <div className="border-b border-line p-5">
        <div className="mb-3 text-xs font-bold tracking-[.06em] text-ink-2 uppercase">
          About{' '}
