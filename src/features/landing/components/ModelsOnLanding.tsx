...
import { Badge, Button, SectionCard, SectionHeader, Toggle } from '@/components/ui';
      ...
      <SectionHeader
        ...
        right={
          <div className="flex gap-1.5">
            ...
            <Button sm onClick={() => dispatch(openModal('add-model'))}>
              + Add Model
            </Button>
          </div>
        }
            ...
            <tr key={m.name}>
              ...
              <td>
                <div className="flex gap-1.5">
                  ...
                  <Button variant="danger" sm onClick={() => dispatch(showToast('ℹ️ Hidden from landing'))}>
                    Hide
                  </Button>
                </div>
              </td>
