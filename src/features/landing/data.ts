...
export const ownerLogbooks: OwnerLogbook[] = [
  {
    name: 'Sergei Vostrikov',
    car: 'BMW M4 COMPETITION',
    meta: 'G82 (2020-2024) / COUPE / username',
    stats: [
      { label: 'Mileage', value: '20 500 km' },
      { label: 'Owned', value: '99 years 12 months' },
    ],
    image: img('linear-gradient(135deg,#4b5563,#1f2937)', '🏎️'),
  },
  {
    name: 'Elena Harper',
    car: 'BMW M4',
    meta: 'F82 (2013-2017) / COUPE / username',
    stats: [
      { label: 'Mileage', value: '15 800 km' },
      { label: 'Leased', value: '1 year 6 months' },
    ],
    image: img('linear-gradient(135deg,#525b66,#2b323b)', '🚗'),
  },
  {
    name: 'James Smith',
    car: 'BMW M4',
    meta: 'F82 (2013-2017) / COUPE / username',
    stats: [
      { label: 'Mileage', value: '10 200 km' },
      { label: 'Owned', value: '0 years 6 months' },
    ],
    image: img('linear-gradient(135deg,#a16207,#713f12)', '🚕'),
  },
  {
    name: 'Fiona Kelly',
    car: 'BMW M4 COMPETITION',
    meta: 'G82 (2020-2024) / 2020 / username',
    stats: [
      { label: 'Mileage', value: '30 000 km' },
      { label: 'Owned', value: '2 years 3 months' },
    ],
    image: img('linear-gradient(135deg,#365314,#1a2e05)', '🚙'),
  },
  {
    name: 'Petr Kostrikov',
    car: 'BMW M4 COMPETITION',
...
const storyText =
  "Nürburgring Nordschleife was always on the bucket list. Last weekend, I finally crossed it off. Here's everything I learned taking the M3 Comp…";

export const ownerStories: OwnerStory[] = [
  {
    car: 'BMW M4 COMPETITION',
    meta: 'G82 (2020-2024) / COUPE / username',
    title: 'First track day with my BMW M4',
    text: storyText,
  ...
  },
  {
    ...
    comments: 10,
    likes: 10,
    image: img('linear-gradient(135deg,#78716c,#292524)', '🚕'),
  },
];
