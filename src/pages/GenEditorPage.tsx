...
import { initGenEditor, updateGenEditor } from '@/features/catalog/catalogSlice';
import { genData } from '@/features/catalog/data';
import { FormGroup, SectionCard, SectionHeader } from '@/components/ui';
        ...
        <SectionCard>
          ...
          <div className="grid grid-cols-2 gap-4 p-5">
            ...
            <FormGroup label="Parent Model" full>
              <select value={editor.model} onChange={(e) => dispatch(updateGenEditor({ model: e.target.value }))}>
